#modified from https://github.com/TeamRocketIst/ctf-usb-keyboard-parser/blob/master/usbkeyboard.py
import sys
KEY_CODES = {
	0x04: ['a', 'A'],
	0x05: ['b', 'B'],
...
def read_bt(file):
	...
	for data in datas:
		shift = int(data.split(':')[0], 16) == 1  # 0x2 is left shift 0x20 is right shift
		key = int(data.split(':')[1], 16)
...
if __name__ == '__main__':
	sys.stdout.write(read_bt("bt_dump"))
